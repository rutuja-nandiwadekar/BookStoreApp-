...
public @ToString class UserDTO {
    ...
    public UserDTO(String firstName, String lastName, String kyc, LocalDate dateOfBirth, LocalDate registeredDate,
                   LocalDate updatedDate, String phoneNumber, String email, String password) {
